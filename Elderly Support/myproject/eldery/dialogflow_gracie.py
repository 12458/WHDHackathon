...
credentials_path = "/Users/faithtan/Documents/GitHub/WHDHackathon/Final/Joel's database test/myproject/eldery/gracie.json"
...
class Session_Client:
    ...
    def dialogflow(self, question):
        ...
        f = open("/Users/faithtan/Documents/GitHub/WHDHackathon/Final/Joel's database test/myproject/eldery/price.json")
        price = json.load(f)
        ...
        if queryResult['action'] == 'order_veg':
            ...
            for i in range(len(veg)):
                ...
                for cate in price.keys():
                    ...
                    if veggie in cate:
                        ...
                        with open("/Users/faithtan/Documents/GitHub/WHDHackathon/Final/Joel's database test/myproject/eldery/order_list.csv", "a") as file:
                            f = csv.writer(file)
                            list1 = [f"{chosen_veg}", f"{quan[i]}", f"{variety1[chosen_veg]}"]
                            f.writerow(list1)
            
            with open("/Users/faithtan/Documents/GitHub/WHDHackathon/Final/Joel's database test/myproject/eldery/order_list.csv", "r") as file2:
                total_cost = 0
                for row in file2:
                    row = row.split(",")
            ...
            order += "Total Cost: $" + str(round(total_cost, 2))

            with open("/Users/faithtan/Documents/GitHub/WHDHackathon/Final/Joel's database test/myproject/eldery/order_list.csv", "w") as file3:
                pass
